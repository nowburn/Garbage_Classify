...
def check_args(FLAGS):
    ...
    #         raise Exception(
    #             'FLAGS.restore_model_path must be a file path, not a directory, %s' % FLAGS.restore_model_path)
    #     if FLAGS.train_url == '':
    ...
    #         raise Exception(
    #             'FLAGS.deploy_script_path must be a directory, not a file path, %s' % FLAGS.deploy_script_path)
    ...
    #         raise Exception(
    #             'FLAGS.freeze_weights_file_path must be a file path, not a directory, %s ' % FLAGS.freeze_weights_file_path)
