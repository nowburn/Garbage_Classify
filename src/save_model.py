...
def save_pb_model(FLAGS, model):
    ...
    shutil.copyfile(os.path.join(FLAGS.deploy_script_path, 'config.json'),
                    os.path.join(pb_save_dir_local, 'model/config.json'))
    shutil.copyfile(os.path.join(FLAGS.deploy_script_path, 'customize_service.py'),
                    os.path.join(pb_save_dir_local, 'model/customize_service.py'))

    if os.path.exists(os.path.join(pb_save_dir_local, 'model/config.json')) and \
            os.path.exists(os.path.join(pb_save_dir_local, 'model/customize_service.py')):
